...
- **Σύγχρονο UI**: Σκοτεινό θέμα (Dark Mode) βασισμένο στο `CustomTkinter` με πυκνή (compact) διάταξη, κουμπιά γρήγορης επικόλλησης (Clipboard) και λειτουργία Focus Mode (☰).
...
- **Δυναμικά Γραφήματα (Matplotlib)**: Επαγγελματικά γραφήματα 3 επιπέδων (Διαγράμματα Κεριών, Όγκος Συναλλαγών και RSI), με δυνατότητα μεγέθυνσης σε νέο παράθυρο και επιλογή χρονικού διαστήματος.
